...
experiment_prefix = "niki-059"

OVERRIDE_ARGS_LIST_AND_MAX_PARALLEL = [
    (
        {
            # Load from HFHub
            "model.name_or_path": f"{project_prefix}_{base_model_name[11:]}_pretrained_{experiment_prefix}_wl_random-token-1280_seed-{seed}",  # noqa: E501
