...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES = [
    ("EleutherAI/pythia-12b-deduped", "pythia-word-length-12b-niki-ada-v1-seed1"),
]
OVERRIDE_ARGS_LIST = [
    {
        ...
        # This should use the same training dataset,
        # but make the dataloader shuffle the data differently.
