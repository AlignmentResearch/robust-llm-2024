# Based on mz_061_search_based_tt_ada_big_cheaper.py
import os
...
MODELS_AND_N_MAX_PARALLEL = [
    ...
    ("AlignmentResearch/robust_llm_pythia-word-length-12b-niki-ada-v1", 1),
]
N_ITS = [1, 3, 10]
    ...
    (
        {
            ...
            "experiment.evaluation.batch_size": 2,
            "experiment.evaluation.evaluation_attack.search_based_attack_config.forward_pass_batch_size": 2,  # noqa: E501
        },
        n_max_parallel,
    )
