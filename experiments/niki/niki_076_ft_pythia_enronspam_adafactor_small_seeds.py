...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES_AND_MAX_N_PARALLEL = [
    ("EleutherAI/pythia-14m", "pythia-spam-14m-niki-ada-v4", 2),
    ("EleutherAI/pythia-31m", "pythia-spam-31m-niki-ada-v4", 2),
    ("EleutherAI/pythia-70m", "pythia-spam-70m-niki-ada-v4", 2),
    ("EleutherAI/pythia-160m", "pythia-spam-160m-niki-ada-v4", 1),
    ("EleutherAI/pythia-410m", "pythia-spam-410m-niki-ada-v4", 1),
    ("EleutherAI/pythia-1b", "pythia-spam-1b-niki-ada-v4", 1),
    ("EleutherAI/pythia-1.4b", "pythia-spam-1.4b-niki-ada-v4", 1),
]
SEEDS = [0, 1, 2]
