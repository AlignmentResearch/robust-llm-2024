"""Model originally trained on random token. Now, evaluate on beam search."""
...
HYDRA_CONFIG = "niki/2024-05-16_niki_049"
...
experiment_prefix = "niki-047"

OVERRIDE_ARGS_LIST_AND_MAX_PARALLEL = [
    (
        {
            # Load from HFHub
            "model.name_or_path": f"{project_prefix}_{base_model_name[11:]}_{experiment_prefix}_wl_random-token-1280_seed-{seed}",  # noqa: E501
