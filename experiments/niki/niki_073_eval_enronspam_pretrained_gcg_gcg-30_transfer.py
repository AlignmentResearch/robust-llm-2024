...
HYDRA_CONFIG = "niki/2024-05-21_niki_065"
...
experiment_prefix = "niki-061"

OVERRIDE_ARGS_LIST_AND_MAX_PARALLEL = [
    (
        {
            # Load from HFHub
            "model.name_or_path": f"{project_prefix}_{base_model_name[11:]}_pretrained_{experiment_prefix}_enronspam_gcg_seed-{seed}",  # noqa: E501
