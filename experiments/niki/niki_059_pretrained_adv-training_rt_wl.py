...
HYDRA_CONFIG = "niki/2024-05-17_niki_059"
    ...
    (
        {
            ...
            "training.force_name_to_save": f"{base_model_name[11:]}_pretrained_{EXP_PREFIX}_wl_random-token-1280_seed-{seed}",  # noqa: E501
            "training.seed": seed,
        },
        max_n_parallel,
    )
