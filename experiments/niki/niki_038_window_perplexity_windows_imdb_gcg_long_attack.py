...
OVERRIDE_ARGS_LIST = [
    {
        ...
        "experiment.evaluation.evaluation_attack.search_based_attack_config.n_attack_tokens": n_attack_tokens,  # noqa: E501
    ...
    for n_attack_tokens in N_ATTACK_TOKENS
