...
HYDRA_CONFIG = "niki/2024-07-12_niki_066a"

BASE_MODEL_NAMES_AND_MAX_PARALLEL = [
    ("EleutherAI/pythia-160m", 2),
]
SEEDS = [0]
ADV_TRAINING_ROUNDS = [5, 6, 7, 8, 9]
project_prefix = "AlignmentResearch/robust_llm"
experiment_prefix = "niki-054a"

OVERRIDE_ARGS_LIST_AND_MAX_PARALLEL = [
    (
        {
            # Load from HFHub
            "model.name_or_path": f"{project_prefix}_{base_model_name[11:]}_{experiment_prefix}_pm_gcg_seed-{seed}",  # noqa: E501
