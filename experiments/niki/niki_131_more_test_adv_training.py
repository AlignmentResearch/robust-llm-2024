...
# ADV_TRAIN_SEEDS = [0]
SCHEDULER_TYPES = ["linear", "constant"]
    ...
    (
        {
            ...
            # ),
            "training.lr_scheduler_type": scheduler_type,
            # Don't save the model, this is just a test run
            "training.model_save_path_prefix_or_hf": None,
            "training.adversarial.num_adversarial_training_rounds": 20,
        },
        n_gpus,
        memory,
        cluster,
