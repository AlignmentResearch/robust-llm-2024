...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES_AND_MAX_N_PARALLEL = [
    ("EleutherAI/pythia-14m", "pythia-pm-14m-niki-ada-v4", 2),
    ("EleutherAI/pythia-31m", "pythia-pm-31m-niki-ada-v4", 2),
    ("EleutherAI/pythia-70m", "pythia-pm-70m-niki-ada-v4", 2),
    ("EleutherAI/pythia-160m", "pythia-pm-160m-niki-ada-v4", 1),
    ("EleutherAI/pythia-410m", "pythia-pm-410m-niki-ada-v4", 1),
    ("EleutherAI/pythia-1b", "pythia-pm-1b-niki-ada-v4", 1),
    ("EleutherAI/pythia-1.4b", "pythia-pm-1.4b-niki-ada-v4", 1),
]
SEEDS = [0, 1, 2]
