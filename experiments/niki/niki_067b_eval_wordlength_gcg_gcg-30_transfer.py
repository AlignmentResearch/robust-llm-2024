...
HYDRA_CONFIG = "niki/2024-07-12_niki_067a"

BASE_MODEL_NAMES_AND_MAX_PARALLEL = [
    ("EleutherAI/pythia-70m", 2),
]
SEEDS = [1]
ADV_TRAINING_ROUNDS = [1, 2, 3, 4, 5, 8, 9]
project_prefix = "AlignmentResearch/robust_llm"
experiment_prefix = "niki-055"

OVERRIDE_ARGS_LIST_AND_MAX_PARALLEL = [
    (
        {
            # Load from HFHub
            "model.name_or_path": f"{project_prefix}_{base_model_name[11:]}_{experiment_prefix}_wl_gcg_seed-{seed}",  # noqa: E501
