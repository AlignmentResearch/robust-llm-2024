...
HYDRA_CONFIG = "niki/2024-05-27_niki_080"

BASE_MODEL_NAMES_AND_MAX_PARALLEL = [
    ("pythia-spam-14m-niki-ada-v4", 2),
    ("pythia-spam-31m-niki-ada-v4", 2),
    ("pythia-spam-70m-niki-ada-v4", 2),
    ("pythia-spam-160m-niki-ada-v4", 1),
    ("pythia-spam-410m-niki-ada-v4", 1),
    ("pythia-spam-1b-niki-ada-v4", 1),
    ("pythia-spam-1.4b-niki-ada-v4", 1),
    ("pythia-spam-2.8b-niki-ada-v4", 1),
]
