"""Adversarial training on IMDD with random token 1280 defense.

Thank you Ian for translating this to the new style!
"""
...
HYDRA_CONFIG = "niki/2024-05-09_niki_047"
    ...
    (
        {
            ...
            "training.force_name_to_save": f"{base_model_name[11:]}_{EXP_PREFIX}_wl_random-token-1280_seed-{seed}",  # noqa: E501
