...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES_AND_MAX_N_PARALLEL = [
    ("EleutherAI/pythia-14m", "pythia-wl-14m-niki-ada-v4", 2),
    ("EleutherAI/pythia-31m", "pythia-wl-31m-niki-ada-v4", 2),
    ("EleutherAI/pythia-70m", "pythia-wl-70m-niki-ada-v4", 2),
    ("EleutherAI/pythia-160m", "pythia-wl-160m-niki-ada-v4", 1),
    ("EleutherAI/pythia-410m", "pythia-wl-410m-niki-ada-v4", 1),
    ("EleutherAI/pythia-1b", "pythia-wl-1b-niki-ada-v4", 1),
    ("EleutherAI/pythia-1.4b", "pythia-wl-1.4b-niki-ada-v4", 1),
]
SEEDS = [0, 1, 2]
