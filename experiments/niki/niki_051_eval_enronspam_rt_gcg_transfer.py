...
experiment_prefix = "niki-046"

OVERRIDE_ARGS_LIST_AND_MAX_PARALLEL = [
    (
        {
            # Load from HFHub
            "model.name_or_path": f"{project_prefix}_{base_model_name[11:]}_{experiment_prefix}_enronspam_random-token-1280_seed-{seed}",  # noqa: E501
