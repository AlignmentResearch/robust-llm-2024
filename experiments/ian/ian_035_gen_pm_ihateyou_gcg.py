...
HYDRA_CONFIG = "ian/035_gen_pm_ihateyou_gcg"
...
MODELS_AND_N_MAX_PARALLEL = [
    ...
    ("AlignmentResearch/robust_llm_pythia-70m-pm-gen-ian-nd", 2),
    ("AlignmentResearch/robust_llm_pythia-160m-pm-gen-ian-nd", 2),
