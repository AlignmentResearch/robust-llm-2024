...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES_AND_PARALLEL = [
    ("EleutherAI/pythia-14m", "pythia-14m-pm_1.2.0-gen-ian-nd", 1),
    ("EleutherAI/pythia-31m", "pythia-31m-pm_1.2.0-gen-ian-nd", 1),
    ("EleutherAI/pythia-70m", "pythia-70m-pm_1.2.0-gen-ian-nd", 1),
    ("EleutherAI/pythia-160m", "pythia-160m-pm_1.2.0-gen-ian-nd", 1),
    ("EleutherAI/pythia-410m", "pythia-410m-pm_1.2.0-gen-ian-nd", 1),
    ("EleutherAI/pythia-1b", "pythia-1b-pm_1.2.0-gen-ian-nd", 1),
    ("EleutherAI/pythia-2.8b", "pythia-2.8b-pm_1.2.0-gen-ian-nd", 1),
]
