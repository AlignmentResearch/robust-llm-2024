...
HYDRA_CONFIG = "ian/032_gen_eval_rt_imdb"

MODELS_AND_N_MAX_PARALLEL = [
    ("AlignmentResearch/robust_llm_pythia-14m-imdb-gen-ian-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-31m-imdb-gen-ian-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-70m-imdb-gen-ian-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-160m-imdb-gen-ian-nd", 1),
