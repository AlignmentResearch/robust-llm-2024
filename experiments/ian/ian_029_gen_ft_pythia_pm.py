...
HYDRA_CONFIG = "ian/029_gen_ft_pythia_pm"

PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES_AND_PARALLEL = [
    ("EleutherAI/pythia-14m", "pythia-14m-pm-gen-ian-nd", 2),
    ("EleutherAI/pythia-31m", "pythia-31m-pm-gen-ian-nd", 2),
    ("EleutherAI/pythia-70m", "pythia-70m-pm-gen-ian-nd", 1),
    ("EleutherAI/pythia-160m", "pythia-160m-pm-gen-ian-nd", 1),
    ("EleutherAI/pythia-410m", "pythia-410m-pm-gen-ian-nd", 1),
    ("EleutherAI/pythia-1b", "pythia-1b-pm-gen-ian-nd", 1),
    ("EleutherAI/pythia-2.8b", "pythia-2.8b-pm-gen-ian-nd", 1),
]
