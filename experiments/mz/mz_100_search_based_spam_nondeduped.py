...
MODELS_AND_N_MAX_PARALLEL = [
    ("AlignmentResearch/robust_llm_pythia-spam-14m-mz-ada-v3-nd", 4),
    ("AlignmentResearch/robust_llm_pythia-spam-31m-mz-ada-v3-nd", 2),
    ("AlignmentResearch/robust_llm_pythia-spam-70m-mz-ada-v3-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-160m-mz-ada-v3-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-410m-mz-ada-v3-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-1b-mz-ada-v3-nd", 1),
]
N_ITS = [1, 3, 10]
