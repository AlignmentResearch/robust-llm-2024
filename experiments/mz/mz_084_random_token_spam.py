...
MODELS_AND_N_MAX_PARALLEL = [
    ("AlignmentResearch/robust_llm_pythia-spam-14m-mz-ada-v3", 4),
    ("AlignmentResearch/robust_llm_pythia-spam-31m-mz-ada-v3", 4),
    ("AlignmentResearch/robust_llm_pythia-spam-70m-mz-ada-v3", 2),
    ("AlignmentResearch/robust_llm_pythia-spam-160m-mz-ada-v3", 2),
    ("AlignmentResearch/robust_llm_pythia-spam-410m-mz-ada-v3", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-1b-mz-ada-v3", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-1.4b-mz-ada-v3", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-2.8b-mz-ada-v3", 1),
]
    ...
    (
        {
            ...
            "experiment.evaluation.batch_size": 16,  # noqa: E501
            "experiment.evaluation.evaluation_attack.random_token_attack_config.batch_size": 16,  # noqa: E501
        },
        n_max_parallel,
    )
