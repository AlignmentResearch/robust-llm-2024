...
MODELS_AND_N_MAX_PARALLEL = [
    ...
    ("AlignmentResearch/robust_llm_pythia-spam-31m-mz-ada-v3", 2),
    ("AlignmentResearch/robust_llm_pythia-spam-70m-mz-ada-v3", 1),
    ("AlignmentResearch/robust_llm_pythia-spam-160m-mz-ada-v3", 1),
