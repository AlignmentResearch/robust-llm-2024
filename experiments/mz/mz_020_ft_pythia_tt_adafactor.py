...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES = [
    ("EleutherAI/pythia-14m", "pythia-tt-14m-mz-ada-v2"),
    ("EleutherAI/pythia-31m", "pythia-tt-31m-mz-ada-v2"),
    ("EleutherAI/pythia-70m-deduped", "pythia-tt-70m-mz-ada-v2"),
    ("EleutherAI/pythia-160m-deduped", "pythia-tt-160m-mz-ada-v2"),
    ("EleutherAI/pythia-410m-deduped", "pythia-tt-410m-mz-ada-v2"),
    ("EleutherAI/pythia-1b-deduped", "pythia-tt-1b-mz-ada-v2"),
    ("EleutherAI/pythia-1.4b-deduped", "pythia-tt-1.4b-mz-ada-v2"),
    ("EleutherAI/pythia-2.8b-deduped", "pythia-tt-2.8b-mz-ada-v2"),
]
OVERRIDE_ARGS_LIST = [
    {
