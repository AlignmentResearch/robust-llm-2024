...
OVERRIDE_ARGS_LIST = [
    {
        ...
        "experiment.evaluation.evaluation_attack.text_attack_attack_config.num_modifiable_words_per_chunk": num_placeholder_words,  # noqa: E501
    }
    for model in MODELS
    for attack_type in ATTACK_TYPES
    for query_budget in QUERY_BUDGETS
    for num_placeholder_words in NUM_PLACEHOLDER_WORDS
]
