...
MODELS_AND_N_MAX_PARALLEL = [
    ("AlignmentResearch/robust_llm_pythia-tt-14m-mz-ada-v3-nd", 4),
    ("AlignmentResearch/robust_llm_pythia-tt-31m-mz-ada-v3-nd", 4),
    ("AlignmentResearch/robust_llm_pythia-tt-70m-mz-ada-v3-nd", 2),
    ("AlignmentResearch/robust_llm_pythia-tt-160m-mz-ada-v3-nd", 2),
    ("AlignmentResearch/robust_llm_pythia-tt-410m-mz-ada-v3-nd", 1),
    ("AlignmentResearch/robust_llm_pythia-tt-1b-mz-ada-v3-nd", 1),
]
N_ITS = [10]
