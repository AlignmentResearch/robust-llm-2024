...
MODELS_AND_N_MAX_PARALLEL = [
    ("AlignmentResearch/robust_llm_pythia-imdb-14m-mz-ada-v2", 4),
    ("AlignmentResearch/robust_llm_pythia-imdb-31m-mz-ada-v2", 2),
    ("AlignmentResearch/robust_llm_pythia-imdb-70m-mz-ada-v2", 1),
    ("AlignmentResearch/robust_llm_pythia-imdb-160m-mz-ada-v2", 1),
    ("AlignmentResearch/robust_llm_pythia-imdb-410m-mz-ada-v2", 1),
    ("AlignmentResearch/robust_llm_pythia-imdb-1b-mz-ada-v2", 1),
    ("AlignmentResearch/robust_llm_pythia-imdb-1.4b-mz-ada-v2", 1),
