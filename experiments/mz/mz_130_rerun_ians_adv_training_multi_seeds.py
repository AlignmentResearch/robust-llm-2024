"""Based on ian_022_adv_training_large_exp but with the following changes:

- decreased n_max_parallel
- use append_to_modifiable_chunk=False for PasswordMatch
- use multiple seeds for each model
- always use n_its=10 to reduce number of runs
- run after incorporating fix for trainer directory


Comment from original experiment:
    ...
    (
        {
            ...
            "experiment.training.iterative.training_attack.append_to_modifiable_chunk": APPEND_TO_MODIFIABLE_CHUNK[  # noqa: E501
                dataset
            ],
            "experiment.evaluation.evaluation_attack.append_to_modifiable_chunk": APPEND_TO_MODIFIABLE_CHUNK[  # noqa: E501
                dataset
            ],
