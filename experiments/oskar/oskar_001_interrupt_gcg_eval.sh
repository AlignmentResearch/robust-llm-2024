...
python robust_llm +experiment=Eval/pm_gcg.yaml dataset.n_val=1000 environment.logging_level=10 evaluation.evaluation_attack.n_its=10 evaluation.evaluation_attack.save_steps=1 run_name=oskar_001_interrupt_gcg_eval &
