...
PYTHIA_NAMES_AND_FINETUNED_TARGET_NAMES = [
    ("EleutherAI/pythia-14m", "pythia-imdb-14m-mz-v1"),
    ("EleutherAI/pythia-31m", "pythia-imdb-31m-mz-v1"),
    ("EleutherAI/pythia-70m-deduped", "pythia-imdb-70m-mz-v1"),
    ("EleutherAI/pythia-160m-deduped", "pythia-imdb-160m-mz-v1"),
    ("EleutherAI/pythia-410m-deduped", "pythia-imdb-410m-mz-v1"),
    ("EleutherAI/pythia-1b-deduped", "pythia-imdb-1b-mz-v1"),
