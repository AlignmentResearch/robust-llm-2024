...
load_and_plot_adv_training_plots(
    ...
    save_as="pm_rt_gcg_transfer_flops",
    save_dir=save_dir,
...
load_and_plot_adv_training_plots(
    ...
    save_as="wl_rt_gcg_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
...
load_and_plot_adv_training_plots(
    ...
    save_as="imdb_rt_gcg_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
...
load_and_plot_adv_training_plots(
    ...
    save_as="spam_rt_gcg_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
...
load_and_plot_adv_training_plots(
    ...
    save_as="imdb_gcg_gcg-30_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
...
load_and_plot_adv_training_plots(
    ...
    save_as="spam_gcg_gcg-30_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
...
load_and_plot_adv_training_plots(
    ...
    save_as="pm_gcg_gcg-30_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
...
load_and_plot_adv_training_plots(
    ...
    save_as="wl_gcg_gcg-30_transfer_flops",
    save_dir=save_dir,
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
