...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "pm_rt_gcg_transfer_flops"),
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "wl_rt_gcg_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "imdb_rt_gcg_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "spam_rt_gcg_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "imdb_gcg_gcg-30_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "spam_gcg_gcg-30_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "pm_gcg_gcg-30_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
...
load_and_plot_adv_training_plots(
    ...
    save_as=(save_dir, "wl_gcg_gcg-30_transfer_flops"),
    summary_keys=transfer_summary_keys,
    x_data_name="n_parameter_updates",
    xlim=xlim,
    legend=legend,
