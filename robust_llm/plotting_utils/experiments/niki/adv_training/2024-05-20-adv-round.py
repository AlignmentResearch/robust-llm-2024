...
#     save_as=f"imdb_rt_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
...
#     save_as=f"spam_rt_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
...
#     save_as=f"pm_rt_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
...
#     save_as=f"wl_rt_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
...
#     save_as=f"imdb_gcg_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
...
#     save_as=f"spam_gcg_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
...
#     ),
#     title="PM, GCG attack",
#     save_as=f"pm_gcg_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
...
#     ),
#     title="WL, GCG attack",
#     save_as=f"wl_gcg_adv_training_{num_rounds}_rounds",
#     summary_keys=summary_keys,
#     x_data_name="adv_training_round",
#     color_data_name="num_params",
#     xlim=xlim,
