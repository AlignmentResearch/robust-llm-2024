...
def do_adversarial_evaluation(
    ...
    victim_training_step_count: int | None = None,
    victim_training_datapoint_count: int | None = None,
    global_step_count: int | None = None,
    global_datapoint_count: int | None = None,
    local_files_path: Path | None = None,
